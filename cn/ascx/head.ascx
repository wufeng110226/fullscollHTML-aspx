<%@ Control Language="C#" AutoEventWireup="true" CodeFile="head.ascx.cs" Inherits="en_ascx_head" %>
<div class="nav_bar">
    <div class="fullpage-inside">
        <div class="nav_list">
            <div class="logo">
                <img src="/en/images/logo.png"></div>
            <ul>
            ...
            <div class="search-input">
                <input type="text" id="txt_SearchKey" name="txt_SearchKey" value="<%= Key %>" class="form-control" onkeydown="keydownsearch();">
                <a class="search-button" onclick="search()"><i></i></a>
            </div>
        </div>
    </div>
</div>
